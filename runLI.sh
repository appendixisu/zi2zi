...
do
    ...
    /usr/local/opt/python@3.7/bin/python3.7 train.py --experiment_dir=experiments \
                    ...
                    --schedule=20 \
                    --L1_penalty=100 \
                    --Lconst_penalty=15 | tee -a shlogLi.log

    # Infer
    /usr/local/opt/python@3.7/bin/python3.7 infer.py --model_dir=experiments/checkpoint/experiment_2 \
                    --batch_size=32 \
                    --source_obj=experiments/data/val.obj \
                    --embedding_ids=130 \
                    --save_dir=save_dir/

    /usr/local/opt/python@3.7/bin/python3.7 infer_by_text.py --model_dir=experiments/checkpoint/experiment_2 \
                    --batch_size=32 \
                    --embedding_id=130 \
                    --save_dir=save_dir/ \
                    --text="人工智慧書法家"
